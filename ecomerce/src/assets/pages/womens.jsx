...
function Womens(props) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        setProductsdata([...response1.data.products, ...response2.data.products, ...response3.data.products, ...response4.data.products, ...response5.data.products]);
  ...
  return (
    <div>
      <h1 style={{ textAlign: 'center', padding: '2rem 0' }}>EXCLUSIVE PRODUCTS FOR WOMENS</h1>
      <Row className="g-4">
        {renderProducts()}
      </Row>
